<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MRF.aspx.cs" Inherits="SR_Tyer_and_Puncture_Service.MRF" %>
     ...
     <!-- Spinner Start -->
        ...
        <div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item active text-white">MRF</li>
            </ol>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 my-auto text-center text-md-end text-white">
                        Designed By <a class="border-bottom" href="MRF.aspx">Raxit Solanki</a> 
                    </div>
                </div>
            </div>
        </div>
