<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Ceat.aspx.cs" Inherits="SR_Tyer_and_Puncture_Service.Ceat" %>
     ...
     <!-- Spinner Start -->
        ...
        <div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item active text-white">CEAT</li>
            </ol>
        </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="img/1.jfif" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 my-auto text-center text-md-end text-white">
                        Designed By <a class="border-bottom" href="Ceat.aspx">Raxit Solanki</a> 
                    </div>
                </div>
            </div>
        </div>
